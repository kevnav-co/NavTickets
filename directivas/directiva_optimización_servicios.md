...
- **Objetivo Principal:** Garantizar que los cálculos de rentabilidad y alertas de inventario sean consistentes y que la carga de datos en la tabla/colección en Supabase esté optimizada mediante caché y paginación.
- **Criterio de Éxito:** Las utilidades deben pasar el 100% de las pruebas unitarias y las peticiones a Supabase deben reducirse en un 30% en escenarios de navegación repetida.
...
- **Consultas en Supabase:** Filtros de consulta de `usePaginatedCollection` (nombre de tabla/colección y constraints).
...
3. **Caché de Paginación:**
   ...
   - Si no, proceder con la consulta a Supabase y actualizar caché.
