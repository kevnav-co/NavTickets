/**
 * Módulo de plantillas de correo electrónico Premium para Navas Máquinas.
 */
 ...
 */
const getMaintenanceEmail = (data) => {
    ...
    <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; color: #333; max-width: 600px; margin: 0 auto; border: 1px solid #eee; border-radius: 10px; overflow: hidden; box-shadow: 0 4px 10px rgba(0,0,0,0.05);">
      ...
      <div style="padding: 35px; line-height: 1.7; background-color: #ffffff;">
        ...
        <div style="background-color: #fafafa; border: 1px solid #f0f0f0; border-left: 6px solid #d32f2f; padding: 20px; margin: 30px 0; border-radius: 4px;">
          <h3 style="margin-top: 0; color: #d32f2f; font-size: 15px; text-transform: uppercase; margin-bottom: 15px;">Detalles del Equipo</h3>
          ...
          <p style="margin: 8px 0; font-size: 14px;"><strong style="color: #d32f2f;">Vencimiento:</strong> ${dueDate}</p>
        </div>
        ...
        <div style="text-align: center; margin: 20px 0;">
          <a href="https://wa.me/573117142337?text=Hola,%20quisiera%20agendar%20un%20mantenimiento%20para%20${encodeURIComponent(machineName)}" style="background-color: #25d366; color: white; padding: 16px 35px; text-decoration: none; border-radius: 50px; font-weight: bold; display: inline-block; box-shadow: 0 4px 12px rgba(37, 211, 102, 0.3);">
        ...
        <div style="text-align: center;">
          <p style="font-size: 13px; color: #999; margin: 5px 0;">Navas Máquinas - Soluciones Gastronómicas Profesionales</p>
          <p style="font-size: 11px; color: #aaa; margin: 5px 0;">Montería, Córdoba | Cel: 311 7142337</p>
        </div>
      </div>
    </div>
  `;
  ...
  return `
    <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; color: #333; max-width: 600px; margin: 0 auto; border: 1px solid #eee; border-radius: 10px; overflow: hidden; box-shadow: 0 4px 10px rgba(0,0,0,0.05);">
      ...
      <div style="padding: 35px; line-height: 1.7; background-color: #ffffff;">
        ...
        <div style="background-color: #f1f8ff; border: 1px solid #e1f5fe; border-left: 6px solid #1976d2; padding: 20px; margin: 30px 0; border-radius: 4px;">
          <h3 style="margin-top: 0; color: #1976d2; font-size: 15px; text-transform: uppercase; margin-bottom: 15px;">Detalles de la Garantía</h3>
          ...
          <p style="margin: 8px 0; font-size: 14px;"><strong style="color: #1976d2;">Fecha de Expiración:</strong> ${expirationDate}</p>
        </div>

        <p>Si ha notado algún funcionamiento inusual, este es el momento ideal para reportarlo y hacer valer su garantía.</p>

        <div style="text-align: center; margin: 35px 0;">
          <a href="https://wa.me/573117142337?text=Hola,%20tengo%20una%20duda%20sobre%20la%20garantia%20de%20mi%20orden%20${orderNumber}" style="background-color: #1976d2; color: white; padding: 16px 35px; text-decoration: none; border-radius: 50px; font-weight: bold; display: inline-block;">
            Contactar Soporte Técnico
          </a>
        </div>

        <p style="font-size: 13px; color: #666; text-align: center; margin-top: 30px;">Gracias por confiar en <strong>Navas Máquinas</strong>.</p>
